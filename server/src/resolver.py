...
async def resolve_create_data(_, info, data):
    return service_create(data)


async def resolve_get_data(_, info, data):
...
async def resolve_update_data(_, info, data):
    return service_update(data)


async def resolve_delete_data(_, info, data):
